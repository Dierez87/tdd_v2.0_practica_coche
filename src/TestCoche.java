...
class TestCoche {
	...
	@Test
	public void test_al_decelerar_un_coche_su_velocidad_disminuye_Diego() {
		Coche nuevoCoche = new Coche();
	...
	@Test
	public void test_al_decelerar_un_coche_su_velocidad_no_puede_ser_menor_que_cero_Diego() {
		Coche nuevoCoche = new Coche();
		nuevoCoche.velocidad = 50;
